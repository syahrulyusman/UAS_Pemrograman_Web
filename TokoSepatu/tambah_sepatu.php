...
<html lang="en">
  <head>
    ...
    <title>Form Tambah Sepatu</title>
  </head>
  <body>
 
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">SILAHKAN TAMBAH SEPATU</h3>
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="form-group">
          <label for="sepatu1">Nama Sepatu</label>
          <input type="text" class="form-control" id="sepatu1" name="nama_sepatu">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="harga1">HargaSepatu</label>
