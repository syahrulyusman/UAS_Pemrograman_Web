...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Warrior Footwear</strong></a>
  ...
  <!-- Menu -->
      <div class="container">
        <a href="tambah_sepatu.php" class="btn btn-success mt-3">TAMBAH DAFTAR SEPATU</a>
        <div class="row">
            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="edit_sepatu.php?id_sepatu=<?php echo $result['id_sepatu']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>

                <a href="hapus_sepatu.php?id_sepatu=<?php echo $result['id_sepatu']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
              </div>
            </div>
          </div>
              <?php endforeach; ?>
  ...
  <div class="container">
    <div class="row footer-body">
      <div class="col-md-6">
      <div class="copyright">
        <strong>Copyright</strong> <i class="far fa-copyright"></i> 2022 -  Designed by Syahrul Yusman</p>
      </div>
      </div>
