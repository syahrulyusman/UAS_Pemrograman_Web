        ...
        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="image/bg.png" class="card-img" alt="Lihat Daftar sepatu">
              <div class="card-img-overlay mt-5 text-center">
               <a href="daftar_sepatu.php" class="btn btn-primary">LIHAT DAFTAR SEPATU</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              <img src="image/keranjang.jpg  " class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center">
               <a href="pesanan.php" class="btn btn-primary">LIHAT KERANJANG</a>
              </div>
            </div>
          </div>
        </div>
