...
if(empty($_SESSION["pesanan"]) OR !isset($_SESSION["pesanan"]))
{
  ...
  echo "<script>location= 'sepatu_pembeli.php'</script>";
}
?>
    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
            <?php $nomor=1; ?>
            <?php $totalbelanja = 0; ?>
            <?php foreach ($_SESSION["pesanan"] as $id_sepatu => $jumlah) : ?>

            <?php 
              include('koneksi.php');
              $ambil = mysqli_query($koneksi, "SELECT * FROM produk WHERE id_sepatu='$id_sepatu'");
          ...
          <tr>
            ...
            <td>
              <a href="hapus_pesanan.php?id_sepatu=<?php echo $id_sepatu ?>" class="badge badge-danger">Hapus</a>
            </td>
          </tr>
            <?php $nomor++; ?>
      ...
      <form method="POST" action="">
        <a href="sepatu_pembeli.php" class="btn btn-primary btn-sm">Lihat Menu</a>
      ...
      if(isset($_POST['konfirm'])) {
          ...
          foreach ($_SESSION["pesanan"] as $id_sepatu => $jumlah)
          {
            $insert = mysqli_query($koneksi, "INSERT INTO pemesanan_produk (id_pemesanan, id_sepatu, jumlah) 
              VALUES ('$id_terbaru', '$id_sepatu', '$jumlah') ");
          }          
